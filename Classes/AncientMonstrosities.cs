...
namespace Delve{
 [Serializable]
 public class AncientMonstrosities:Unit{
  public string Description=string.Empty;
  private readonly string[] name1={"Orbos","Acras","Sange","Enrom","Kos","Manegokk","Donir","Samri","Ild","Skyde","Lokrum","Partus","Metus"};
  ...
  public AncientMonstrosities(Card c1,Card c2,Card c3,int lvl,Position p){
   Type=UnitType.AncientMonstrosity;
   Pos=p;
   STR=100;
  ...
  public AncientMonstrosities(Card c,int lvl,Position p){
   Type=UnitType.AncientMonstrosity; 
   Pos=p;
   STR=25;
   STR+=lvl*5;
   Name=name1[c.Value];
   Description+=getTrait(c.Value)+"\r\n";
  }
